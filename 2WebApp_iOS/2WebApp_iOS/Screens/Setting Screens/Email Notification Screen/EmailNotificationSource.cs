...
namespace WebApp_iOS
{
	public class EmailNotificationSource: UITableViewSource
	{
		...
		{
			var cell = tableView.DequeueReusableCell (EmailNotificationCell.Key) as EmailNotificationCell;
			if (cell == null) {
				cell = new EmailNotificationCell ();
				cell.switchBtn.ValueChanged+= (s, e) => {
					emailNotificationController.SwitchValueChanges(cell.Section,cell.Row);
				};
			}
