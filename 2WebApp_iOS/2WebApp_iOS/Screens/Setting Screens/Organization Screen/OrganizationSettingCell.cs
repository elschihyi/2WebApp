...
{
	public class OrganizationSettingCell: UITableViewCell
	{
		public static readonly NSString Key = new NSString ("OrganizationSettingCell");
		public int Row;
		public UILabel nameLabel;
		public UIButton RequestBtn;

		public OrganizationSettingCell ()
		{
