...
{
	public class RequestOrganizationCell: UITableViewCell
	{
		public static readonly NSString Key = new NSString ("RequestOrganizationCell");
		public int Row;
		public UIButton RequestBtn;
		public RequestOrganizationCell (): base ()
		{
			...
			RequestBtn.SetTitle ("Join New Organization",UIControlState.Normal);
